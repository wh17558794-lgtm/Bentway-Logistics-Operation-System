...
alter table public.shipments
  drop column fuel_levy;

alter table public.shipments
  add column fuel_levy numeric(14, 2)
  generated always as (
    case
...
comment on column public.shipments.fuel_levy is
  'Calculated fuel levy using a minimum billable volume of 1 m3.';

comment on column public.shipments.total_charge is
  'Calculated shipment charge using a minimum billable volume of 1 m3; Pending Warehouse Booking uses only its booking amount.';
