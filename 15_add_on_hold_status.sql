...
comment on column public.shipments.on_hold_started_at is
  'Date from which an open shipment was placed on hold.';
...
begin
  ...
  if p_status not in ('pending', 'scheduled', 'on_hold', 'out_for_delivery') then
